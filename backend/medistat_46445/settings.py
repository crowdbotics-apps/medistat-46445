"""
Django settings for medistat_46445 project.
...
ROOT_URLCONF = 'medistat_46445.urls'
...
WSGI_APPLICATION = 'medistat_46445.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "medistat_46445 API",
    "DESCRIPTION": "API documentation for medistat_46445 App",
    "VERSION": "v1",
}
